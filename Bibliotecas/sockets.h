...
typedef enum {
	...
	DTB_EJECUTO, DUMMY_BLOQUEA, DTB_BLOQUEAR, PROCESS_TIMEOUT, QUANTUM_FALTANTE, WAIT, SIGNAL,	// Emisor: CPU, Receptor: SAFA
	DUMMY_SUCCESS, DUMMY_FAIL_CARGA, DUMMY_FAIL_NO_EXISTE, DTB_SUCCESS, ARCHIVO_ABIERTO, ARCHIVO_CERRADO, DTB_FINALIZAR,			// Emisor: Diego, Receptor: SAFA
	...
	ABORTARA = 20001, FALLO_DE_SEGMENTO_ASIGNAR, ESPACIO_INSUFICIENTE_ASIGNAR,	//Errores ASIGNAR
	ABORTARF = 30001, FALLO_DE_SEGMENTO_FLUSH, ESPACIO_INSUFICIENTE_FLUSH, ARCHIVO_NO_EXISTE_FLUSH,	//Errores FLUSH
	ABORTARC = 40001, FALLO_DE_SEGMENTO_CLOSE,	//Errores CLOSE
